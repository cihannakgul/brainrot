...
class InterstitialAdsManager: NSObject, GADFullScreenContentDelegate, ObservableObject {
   ...
   private struct AdMobConstant2 {
       static let interstitial1ID = "ca-app-pub-6303466444103792/5537130616" //TODO: Change it
   }
  ...
  @Published var interstitialAdLoaded:Bool = false
   ...
   func loadInterstitialAd(){
       GADInterstitialAd.load(withAdUnitID: AdMobConstant2.interstitial1ID, request: GADRequest()) { [weak self] add, error in
